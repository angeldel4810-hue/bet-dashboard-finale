...
def init_db():
    ...
    serial_primary_key = "SERIAL PRIMARY KEY" if psql else "INTEGER PRIMARY KEY AUTOINCREMENT"
    text_type = "TEXT"
    real_type = "DOUBLE PRECISION" if psql else "REAL"
    ...
    default_settings = {
        "overround": "5",
        "active_sports": "soccer_italy_serie_a,soccer_italy_serie_b,soccer_italy_serie_c_girone_a,soccer_italy_serie_c_girone_b,soccer_italy_serie_c_girone_c,soccer_epl,soccer_efl_champ,soccer_spain_la_liga,soccer_germany_bundesliga,soccer_france_ligue_one,soccer_usa_mls,soccer_brazil_campeonato",
        "odds_source": "api",
