...
class CrashEngine:
    ...
    async def _run_round(self):
        ...
        # Invece di sleep(1) × 10, aspettiamo con sleep(0.25) e
        ...
        while self.status == "running":
            ...
            # Broadcast SOLO se il moltiplicatore è cambiato di almeno 0.01
            ...
            # Sleep adattivo: più lento quando il mult cresce lentamente
            # (all'inizio ~150ms, poi si riduce per apparire più fluido)
    ...
    # Alias per compatibilità con codice esistente in main.py
